...
export const Configuracion = () => {
  ...
  return (
    <>
      <Helmet>
        <title>CajaPyme | Configuración</title>
        <meta name="description" content="Configura tu cuenta, usuarios y preferencias en CajaPyme. Seguridad y control para tu PYME." />
        <meta name="keywords" content="CajaPyme, configuración, usuarios, seguridad, pymes, gestión, chile" />
        <meta property="og:title" content="CajaPyme | Configuración" />
        <meta property="og:description" content="Configura tu cuenta, usuarios y preferencias en CajaPyme." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://caja-pyme.vercel.app/configuracion" />
